...
export const strings = {
  en: { thanks: 'Thanks for your purchase.', intro: 'Your files are ready. Links work for 30 days; if they expire, reply to your order email and we will send new ones.', mailed: 'A copy of these links has been emailed to', missing: 'This product will be delivered by email shortly.', bye: 'Any question, just reply to the order email.', back: 'Back to the store', title: 'Your download', unpaid: 'This payment has not been completed.', invalid: 'We could not find this order. If you paid, reply to your order email or write to hello@icemanstudio.com.' },
  es: { thanks: 'Gracias por tu compra.', intro: 'Tus archivos están listos. Los enlaces funcionan durante 30 días; si caducan, responde al correo del pedido y te enviamos otros.', mailed: 'Te hemos enviado una copia de estos enlaces a', missing: 'Este producto se entregará por correo en breve.', bye: 'Cualquier duda, responde al correo del pedido.', back: 'Volver a la tienda', title: 'Tu descarga', unpaid: 'Este pago no se ha completado.', invalid: 'No encontramos este pedido. Si has pagado, responde al correo del pedido o escribe a hola@icemanstudio.com.' }
};
