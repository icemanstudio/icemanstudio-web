...
export async function onRequestPost({ request, env }) {
  ...
  const html = `<div style="font-family:Inter,Segoe UI,Arial,sans-serif;max-width:560px;color:#131313"><h2 style="margin:0 0 8px">${T.hi}</h2><p>${T.intro}</p>` +
    ...
    `<p style="margin-top:18px"><a href="${page}">${lang === 'es' ? 'Página de descarga' : 'Download page'}</a></p><p style="margin-top:22px">${T.bye}<br>IceMan Studio · icemanstudio.com</p></div>`;
